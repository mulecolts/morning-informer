...
public class NewsSourceDataTest {
	...
	@Test
	public void test() {
		assertFalse(NewsSourceDescription.RSS_CLARIN
				.equals(NewsSourceDescription.RSS_LA_NACION_ULTIMAS));
		...
		assertFalse(NewsSourceDescription.TWITTER.equals(NewsSourceDescription.TWITTER
				.withProperty("foo", "bar")));

		assertEquals(NewsSourceDescription.TWITTER.withProperty("foo", "bar"),
				NewsSourceDescription.TWITTER.withProperty("foo", "bar"));
		assertNotSame(NewsSourceDescription.TWITTER.withProperty("foo", "bar"),
				NewsSourceDescription.TWITTER.withProperty("foo", "bar"));
		assertFalse(NewsSourceDescription.TWITTER.withProperty("foo", "bar")
				.withProperty("baz", "qux")
				.equals(NewsSourceDescription.TWITTER.withProperty("foo", "bar")));

		NewsSourceDescription data = NewsSourceDescription.TWITTER.withProperty("foo", "bar")
				.withProperty("baz", "qux");
	...
	public void factoryTest() {
		...
		NewsSourceDescription data = NewsSourceDescriptionFactory.create("rss",
				"LA NACION ULTIMAS", properties);
		...
		assertEquals(data,
				NewsSourceDescription.TWITTER.withProperty("screenName", "foo"));
